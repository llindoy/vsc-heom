...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        std::cerr << "Lambdam: " << Lambdam << " Lambdac: " << Lambdac << std::endl;
        ...
        linalg::matrix<complex_type> temp = side*rhobeta2;
        linalg::matrix<complex_type> rho0 = rhobeta2*temp;;
...
//        linalg::matrix<complex_type> flux = sidev * 
        ...
        //thermalise
        {
            ...
            std::cout << "0.0 " << linalg::real(val) << std::endl;
            ...
            for(size_t i = 0; i < nsteps; ++i)
            {
                ...
                std::cout << (i+1)*dt/from_fs << " " << linalg::real(val) << std::endl;
                //for(size_t j = 0; j < nhilb; ++j){ std::cout << std::real(ados[0](j, j)) << " ";}    std::cout << std::endl;
            }
        }
